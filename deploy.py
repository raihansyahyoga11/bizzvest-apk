...
if __name__ == '__main__':
    ...
    target_app_file = "bizzvest.apk"

    # Upload app file and get shared url
    temp = os.path.join(options.release_dir, "app-release.apk")
    file_url = upload_to_dropbox(target_app_file, temp, options.dropbox_token, options.dropbox_folder)
    if file_url == None:
